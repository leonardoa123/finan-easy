...
class ProveedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proveedor" do
    assert_difference("Proveedor.count") do
      post proveedors_url, params: { proveedor: { nombre_proveedor: @proveedor.nombre_proveedor, rut_proveedor: @proveedor.rut_proveedor } }
    end
  ...
  test "should update proveedor" do
    patch proveedor_url(@proveedor), params: { proveedor: { nombre_proveedor: @proveedor.nombre_proveedor, rut_proveedor: @proveedor.rut_proveedor } }
